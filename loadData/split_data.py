...
def split_data(gt_reshape, class_num, train_ratio, val_ratio, train_num, val_num, samples_type):
    ...
    if samples_type == 'ratio':
        ...
        for i in range(class_num+1):
            ...
            if i>0:
                ...
                val_index.append(idx[:sample_num])
    ...
    print('number of training sample', len(train_index))
    print('number of validation sample', len(val_index ))
    print('number of testing sample', len(test_index))
